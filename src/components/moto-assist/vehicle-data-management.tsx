...
import { LoaderCircle, PlusCircle, Trash2, X, Tag, GripVertical } from "lucide-react";
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Add, edit, or remove vehicle brands, emission types, and models. Click 'Save All Changes' when you're done.
        </CardDescription>
      </CardHeader>
